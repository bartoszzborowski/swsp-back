...
class CreateAttendance extends Mutation
{
    public const MUTATION_NAME = 'createAttendance';
    ...
    public function args(): array
    {
        return [
            [
                ...
                'type' => GraphqlType::listOf(GraphQL::type(AttendanceInputType::TYPE_NAME))]
        ];
    }
    ...
    public function resolve($root, $args)
    {
        ...
        try {
            ...
            foreach ($args as $arg) {
                $test->push($this->attendanceRepository->create($arg));
            }
